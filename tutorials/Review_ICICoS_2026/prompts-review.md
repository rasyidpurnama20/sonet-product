...
> Gunakan setelah `skill-ekstraksi.md` selesai · Juni 2026

---

**Alur kerja:**
```
skill-ekstraksi.md  →  A: Analisis  →  B: Draft Review  →  C: Isi Template
...
[paste hasil dari skill-ekstraksi.md]
...
### B0 — Quick Generate *(prompt 2 kalimat, langsung ke format template)*

Gunakan jika sudah paham paper dan ingin draft paling cepat.

```
Paper ini: [paste hasil skill-ekstraksi.md].
Tulis review ICICoS dalam bagian: Summary · Strengths (3 poin bernomor) · Weaknesses and Suggestions (3 poin bernomor, tiap poin sertakan saran perbaikan) · Questions for Authors (2 poin) · Decision: pilih satu dari Accept / Minor Revision / Major Revision / Reject · Confidence: pilih satu dari Expert / Knowledgeable / Passing Knowledge / Basic.
```

> Output langsung bisa dipetakan ke `review-template.docx`.
> Edit setiap kalimat sebelum paste ke `fill_review.py`.
...
> Jawab pertanyaan-pertanyaan itu, baru minta output. Hasilnya langsung relevan.

---

### T2 — Pre-mortem: Balik Framing

*Mengapa powerful:* Bertanya "kenapa paper ini ditolak?" memaksa AI mencari argumen yang *benar-benar substantif*, bukan daftar kelemahan permukaan.
...
[paste hasil skill-ekstraksi.md]
```

> Output-nya lebih tajam dan lebih mudah dikonversi ke weakness comments.

---

### T3 — Steelman First, Lalu Serang

*Mengapa powerful:* Paksa AI membangun argumen terkuat untuk paper dulu — kelemahannya akan ditemukan dari tempat yang lebih dalam.
...
> Kelemahan dari cara ini lebih akurat dan lebih sulit dibantah penulis.

---

### T4 — Persona dengan Failure Mode

*Mengapa powerful:* "Reviewer IEEE" terlalu umum. Domain spesifik + kebiasaan khas reviewer mengunci AI ke perspektif yang jauh lebih tajam.
...
[paste ekstraksi Langkah 2 dari skill-ekstraksi.md]
```
...
*Mengapa powerful:* Memberitahu AI apa yang TIDAK boleh ditulis lebih efektif daripada mendeskripsikan yang harus ditulis — memotong seluruh kategori output buruk sekaligus.
...
> Tanpa pembatasan ini, AI hampir selalu menggunakan frasa hedging yang tidak profesional.

---

### T6 — Kill Your Darlings

*Mengapa powerful:* Paksa AI mengevaluasi outputnya sendiri dan memperkuat bagian yang paling mudah dibantah.

```
Berikut draft review yang sudah kamu buat:
[paste output dari B1]

Dari semua weakness comment di atas, mana 2 yang paling mudah
dibantah oleh penulis? Jelaskan kenapa, lalu tulis versi yang
lebih kuat dengan bukti yang lebih spesifik dari paper.
```

> Biasanya mengungkap komentar yang terlalu generik atau tidak punya referensi kuat.

---

### T7 — Format sebagai Scaffold Berpikir

*Mengapa powerful:* Format output memaksa AI berpikir dalam urutan tertentu — bisa membuat AI menangkap inkonsistensi yang biasanya terlewat.
...
> Format harap–temukan–gap memaksa deteksi inkonsistensi antara klaim dan bukti.

---

### T8 — Confidence Tagging

*Mengapa powerful:* AI sering menyampaikan spekulasi dengan keyakinan yang sama seperti fakta. Tag kepercayaan menunjukkan persis mana yang perlu diverifikasi manual.

```
Setelah setiap komentar review yang kamu tulis, tambahkan tag:
[TINGGI] — didukung langsung oleh isi paper
[SEDANG] — perlu dikonfirmasi reviewer
[RENDAH] — asumsi atau inferensi, reviewer harus verifikasi sendiri
...
> Semua komentar [RENDAH] harus kamu buka langsung di PDF sebelum submit.

---

> **Kombinasi terbaik:**
> **T1** (tanya dulu) → **T4** (persona) saat jalankan B1 → **T8** (confidence tag) → **T6** (perkuat yang lemah)
...
| B0 | Draft cepat, sudah paham paper | ~3 mnt |
...
| T1–T8 | Tingkatkan kualitas prompt apapun | situasional |
